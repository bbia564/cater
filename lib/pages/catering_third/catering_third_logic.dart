...
class CateringThirdLogic extends GetxController {
  ...
  cleanCateringData() async {
    Get.dialog(AlertDialog(
      ...
      actions: [
        ...
        TextButton(
          onPressed: () async {
            await dbCatering.cleanCateringData();
            Get.back();
          },
          child: const Text(
            'OK',
  ...
  aboutCateringPrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutCateringUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can track your daily calories for you"""),
      ],
      context: context,
    );
  }
